...
class AslLstmModel(pl.LightningModule):
    def __init__(self, input_size, output_size, num_layers=3, hidden_size=64):
        ...
        # self.lstm_layers.append(nn.LSTM(input_size=input_size, hidden_size=64, batch_first=True))
        # self.lstm_layers.append(nn.LSTM(input_size=64, hidden_size=128, batch_first=True))
        # self.lstm_layers.append(nn.LSTM(input_size=128, hidden_size=64, batch_first=True))
